...
LOCAL_SRC_FILES := inject.cpp config.cpp riru_config.cpp child_gating.cpp remapper.cpp sanitizer.cpp soinfo_hide.cpp atexit_hide.cpp $(XDL_FILES:$(LOCAL_PATH)/%=%)
