...
LOCAL_SRC_FILES := inject.cpp config.cpp child_gating.cpp remapper.cpp sanitizer.cpp soinfo_hide.cpp atexit_hide.cpp main_zygisk.cpp $(XDL_FILES:$(LOCAL_PATH)/%=%)
